...
class MongoAdapter {
  constructor (name) {
    ...
    // NOTE: you should never be creating indexes at runtime in production,
    // the following is in place just for demonstration purposes of the indexes
    // required
    collections.add(this.name)
  }

  // NOTE: the payload for Session model may contain client_id as keys,
  // make sure you do not use dots (".") in your client_id value charset.
  ...
  // This is not part of the required or supported API,
  // all initialization should happen before
